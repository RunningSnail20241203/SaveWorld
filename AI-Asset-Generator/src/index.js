/**
 * AI Asset Generator - 入口文件
 * 末世生存合成游戏 - AI游戏资产生成 (图片/音效/音乐)
 * 
 * 使用方法:
...
function parseArgs() {
  ...
  for (let i = 0; i < args.length; i++) {
    ...
    switch (arg) {
      ...
      case '--version':
      case '-v':
        console.log('AI Asset Generator v2.0.0');
        process.exit(0);
    }
  }
...
function printHelp() {
  console.log(`
🎮 AI Asset Generator - 末世生存合成 (v2.0)
================================================
...
图片生成选项 (阿里云百炼 Z-Image):
  --generate-image, -g     同时生成图片 (需配置API)
  --size, -s <尺寸>        指定图片尺寸 (默认: 1024*1024)
                            可用: 1024*1024, 1280*1280, 1024*1536, 1536*1024,
                                  1104*1472, 1472*1104, 1536*1536 等
...
async function main() {
  console.log('========================================');
  console.log('🎮 AI Asset Generator - 末世生存合成 v2.0');
  console.log('========================================\n');
